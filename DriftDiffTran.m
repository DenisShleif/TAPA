...
Simulation = 'GaussianTwoCarRCDenis';
Simulation = 'PNJctEqBiasDenis';
...
elseif strcmp(Simulation,'GaussianTwoCarRCDenis')
    eval('SetGaussian2CarParasRCOnlyDenis');
elseif strcmp(Simulation,'PNJctEqBiasDenis')
    eval('SetPNJctParasEqBCBiasDenis');
end
