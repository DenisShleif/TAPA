...
NdRange = [1e16,20e16];
Nd = NdRange(1); % Const. 1/cm3 (100 cm/m)^3
%Nd = linspace(NdRange(1),NdRange(2),nx);
%Nd = exp(linspace(log(NdRange(1)),log(NdRange(2)),nx));
NetDoping = ones(1,nx).*Nd*1e6; % doping
